...
Status: (Choose one: Safe, Suspicious, Unsafe)
Reason: (Explain *why* you chose that status based on the URL's characteristics)
Risk: (Describe the potential danger, e.g., "May steal login or payment data," "May install malware on your device.")
Advice: (Tell the user what to do, e.g., "Do not open this link," "Proceed with caution," "This link appears to be safe.")`,
});
